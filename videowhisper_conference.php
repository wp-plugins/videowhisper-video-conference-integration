...
<select name="alwaystRTMP" id="alwaystRTMP">
  <option value="0" <?php echo $options['alwaystRTMP']?"":"selected"?>>No</option>
  <option value="1" <?php echo $options['alwaystRTMP']?"selected":""?>>Yes</option>
</select>
